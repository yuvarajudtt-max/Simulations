...
public class GlobalExceptionHandler {
   ...
   private static final Logger log = LoggerFactory.getLogger(GlobalExceptionHandler.class);
    ...
    public ResponseEntity<ErrorResponse> handleConsentNotFoundException(
        ...
        log.error("{} Consent not found: {}", CLASS,ex.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleConsentValidationException(
            ConsentValidationException ex, WebRequest request) {

        log.error("Consent validation error: {}", ex.getMessage());
