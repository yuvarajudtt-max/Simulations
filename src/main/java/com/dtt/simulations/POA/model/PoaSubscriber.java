...
@NamedQuery(name="PoaSubscriber.findAll", query="SELECT s FROM PoaSubscriber s")
public class PoaSubscriber implements Serializable {
	...
	public String toString() {
		return "Subscriber [subscriberId=" + subscriberId + ", createdDate=" + createdDate + ", dateOfBirth="
				...
				+ appVersion + ", deviceInfo=" + deviceInfo + ", nationalId=" + nationalId + ", smartPhoneUser="
				+ smartPhoneUser + "]";
	}
